...
public:
   ...
   //	unsigned char TempDB[500][1200];
    ...
    int id_plc ;
    int PLCPort ;
    int dbwatchdog_pc,wordwatchdog_pc,typewatchdog, bit_watchdog_pc;
    int dbwatchdog_plc,wordwatchdog_plc, bit_watchdog_plc;
...
extern void CreateAndResumeSiemensThread();
extern void StopSiemensThread();
//----------------------------------------------------------------------------
#endif
