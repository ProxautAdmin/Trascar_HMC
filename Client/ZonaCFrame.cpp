...
// ---------------------------------------------------------------------------
__fastcall TfrZonaC::TfrZonaC(TComponent* Owner) : TFrame(Owner) {
       Zona = "C"    ;
}

// ---------------------------------------------------------------------------

void TfrZonaC::AggiornaDati() {
...
void __fastcall TfrZonaC::pnPosCMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
        TPanel *Pan;
    Pan = (TPanel*) Sender;
    if (Pan != NULL) {
