...
public:
	...
	UINT8 UscitePhoenix[8];
	UINT8 UscitePhoenixDaScrivere[8];
	IBDDIHND dtiHnd;
	IBDDIRET ddiRet ;
	...
	int device,connesso,error_scrittura ;
	bool devoscrivere,stabilisci_connessione,leggi_output ;
};
//---------------------------------------------------------------------------
extern Phoenix_Thread *PLCPhoenixThread[6];
