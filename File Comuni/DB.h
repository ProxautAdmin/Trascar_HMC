...
private: // User declarations
    ...
    int UpdatePos(int pos, int prenota, int escludi, int TipoUDC, int Tipoposizione, int Selezionata);
    int UpdateCorsia(int corsia, int prenota, int abilitata, int piena, int vuota, int inusoprel, int inusodep, int prior, int tipologia, int IgnoraRifOrdine, int depselettivo, AnsiString Annotazioni, AnsiString CodiceArticolo = "", AnsiString Lotto = "");
    ...
    int UpdatePiano(int pos, int piano, int IdUDC, int hprel, int hdep, AnsiString tipopiano, int disabilitata, int artudc);
